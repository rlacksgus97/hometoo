...
class Profile extends React.Component {
  ...
  withdrawUser = async function () {
    if(window.confirm("모든 활동내역들을 복구 할 수 없습니다.\n정말로 탈퇴하시겠습니까?")) {
  ...
  componentDidMount() {
    ...
    axios.get("http://localhost:8080/api/challenges/my/count/"+this.state.name).then(res => {
                    ...
                    <Row className="justify-content-center">
                      ...
                      <Col className="order-lg-1" lg="4">
                        <div className="card-profile-stats d-flex justify-content-center">
                          <div onClick={() => window.location.href="/challenge/mychallenge"} style={{cursor:'pointer'}}>
                            <span className="heading">{this.state.challenges}개</span>
