                ...
                <main ref="main">
                    ...
                    <section className="section section-components pb-0">
                        <Container className="justify-content-md-center" fluid>
                            ...
                            {/*        <CardBody className="bg-gradient-secondary shadow">*/}
                            {/*    <h4 className="display-3 text-black">챌린지 영상</h4>*/}
                            {/*    <video src="C:\Users\jin\Downloads\다빈치스포츠-10.mp4" controls>*/}
                            {/*        비디오 재생 중 에러가 발생했습니다.*/}
                            {/*    </video>*/}
                            {/*    </CardBody>*/}
                            {/*        </Card>*/}
                                ...
                                <Col lg="8">
                                    <Card className="bg-gradient-secondary shadow">
                                        <CardBody className="p-lg-5">
                                            ...
                                            {/*</p>*/}
                                            <h4 className="display-3 text-black">챌린지 영상</h4>
                                            <video src="C:\Users\jin\Downloads\다빈치스포츠-10.mp4" crossOrigin="anonymous" type="type/mp4" controls width="60%">
                                                비디오 재생 중 에러가 발생했습니다.
                                            </video>
                                            <FormGroup
